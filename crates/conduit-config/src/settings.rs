...
pub fn parse_action(name: &str) -> Option<Action> {
    match name {
        ...
        "toggle_orchestration_default" => Some(Action::ToggleOrchestrationDefault),
        ...
        "toggle_mcp_scope" => Some(Action::ToggleMcpScope),
...
pub fn action_to_name(action: &Action) -> Option<&'static str> {
    match action {
        ...
        Action::ToggleOrchestrationDefault => Some("toggle_orchestration_default"),
        ...
        Action::ToggleMcpScope => Some("toggle_mcp_scope"),
