...
fn load_history_for_session(session: &SessionTab) -> Vec<ChatMessage> {
    ...
    let mut messages = match session.agent_type {
        ...
        AgentType::Dirac | AgentType::Gemini | AgentType::Cecli | AgentType::Copilot => Vec::new(),
...
pub async fn get_session_events(
    ...
    let messages = match session.agent_type {
        ...
        AgentType::Dirac | AgentType::Gemini | AgentType::Cecli | AgentType::Copilot => {
...
pub async fn fork_session(
    ...
    conduit_git::sync_remote(&base_repo_path);
