...
use conduit_agent::{AgentMode, AgentType, ReasoningEffort};
use uuid::Uuid;
...
impl AppState {
    pub fn new(max_tabs: usize) -> Self {
        Self {
            ...
            mcp_dialog_state: McpDialogState::new(),
    ...
    pub fn has_active_overlay(&self) -> bool {
        self.base_dir_dialog_state.is_visible()
            ...
            || self.mcp_dialog_state.is_visible()
