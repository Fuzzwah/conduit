use crate::app::App;
use crate::app_state::SelectionDragTarget;
...
impl App {
    pub(super) fn handle_selection_start(&mut self, x: u16, y: u16) -> bool {
        ...
        if self.state.view_mode != crate::events::ViewMode::Chat {
            return false;
        }
    ...
    pub(super) fn handle_selection_end(&mut self) -> Option<Vec<crate::effect::Effect>> {
        ...
        if let Some(text) = copied_text {
            effects.push(crate::effect::Effect::CopyToClipboard(text));
