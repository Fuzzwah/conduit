...
use crate::app::App;
use crate::app_state::ScrollDragTarget;
use crate::components::{scrollbar_offset_from_point, RawEventsScrollbarMetrics, ScrollbarMetrics};
...
impl App {
    ...
    pub(super) fn raw_events_detail_visible_height(&self) -> usize {
        ...
        if area.width < crate::components::DETAIL_PANEL_BREAKPOINT {
